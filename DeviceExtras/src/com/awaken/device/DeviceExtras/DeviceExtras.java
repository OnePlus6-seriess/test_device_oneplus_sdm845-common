...
import com.awaken.device.DeviceExtras.alertslider.SliderSettingsActivity;
import com.awaken.device.DeviceExtras.doze.DozeSettingsActivity;
import com.awaken.device.DeviceExtras.touch.TouchSettingsActivity;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mAutoHBMSwitch) {
            ...
            Intent hbmIntent = new Intent(this.getContext(),
                    com.awaken.device.DeviceExtras.HBMModeService.class);
            if (enabled) {
            ...
            Intent fpsinfo = new Intent(this.getContext(),
                    com.awaken.device.DeviceExtras.FPSInfoService.class);
            if (enabled) {
